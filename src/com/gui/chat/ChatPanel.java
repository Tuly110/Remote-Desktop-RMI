...
public class ChatPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        this.message_text.setFont(new Font("Trebuchet MS", Font.PLAIN, 14));
        ...
        this.send_label.setFont(new Font("Trebuchet MS", Font.PLAIN, 13));
        ...
        this.file_label.setFont(new Font("Trebuchet MS", Font.PLAIN, 13));
    ...
    public String getHostName() {
        return this.chat_bus.getSocket().getInetAddress().getHostName();
    }
