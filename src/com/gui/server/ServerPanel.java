...
public class ServerPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        this.status_label.setFont(new Font("Trebuchet MS", Font.ITALIC | Font.BOLD, 13));
        ...
        this.listen_label.setForeground(Color.decode("#b38ff7")); // Đặt màu cho JLabel
        this.listen_label.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
        ...
        this.listen_label.setForeground(Color.decode("#b38ff7")); // Đặt màu cho JLabel
        this.stop_label.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
