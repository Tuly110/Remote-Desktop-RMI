...
public class CommonLabel extends JLabel {
    public final static String FOREGROUND = "#1f2521";
    ...
    public void setSmallFont() {
        this.setFont(new Font("Trebuchet MS", Font.PLAIN, CommonLabel.SMALL_FONT_SIZE));
    }

    public void setBigFont() {
        this.setFont(new Font("Trebuchet MS", Font.PLAIN, CommonLabel.BIG_FONT_SIZE));
    }

    public void resetFont() {
        int font_size = this.getFont().getSize();
        this.setFont(new Font("Trebuchet MS", Font.PLAIN, font_size));
    }
    ...
    private void tabLabelMouseEntered(MouseEvent e) {
        if(this.isEnabled()) {
            ...
            int font_size = this.getFont().getSize();
            this.setFont(new Font("Trebuchet MS", Font.BOLD, font_size));
        }
    }
