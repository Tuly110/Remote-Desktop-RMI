...
public class CommonPanel extends JPanel {
    ...
    private void initcomponents() {
        ...
        this.pass_text.setFont(new Font("Trebuchet MS", Font.PLAIN, 12));
        ...
        this.pass_field.setFont(new Font("Trebuchet MS", Font.PLAIN, 12));
        ...
        this.help_label.setFont(new Font("Trebuchet MS", Font.BOLD, 13));
