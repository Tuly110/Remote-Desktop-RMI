...
public class ClientPanel extends JPanel {
    public final static String BACKGROUND = "#FFC0CB";
    public final static String FOREGROUND = "#20B2AA";
    ...
    private static final Color TITLE_BORDER_COLOR = Color.decode("#282d2a"); // Màu cho TitledBorder
    ...
    private void initComponents() {
        ...
        this.main_panel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(TITLE_BORDER_COLOR, 2), // Đường viền với màu
                "Connect To Server",
                TitledBorder.DEFAULT_JUSTIFICATION,
                TitledBorder.DEFAULT_POSITION,
                new Font("Trebuchet MS", Font.BOLD, 16),
                TITLE_BORDER_COLOR // Màu chữ tiêu đề
        ));
        ...
        this.main_panel.setFont(new Font("Trebuchet MS", Font.PLAIN, 12));
        ...
        this.main_panel.getHelpLabel()
                .setText
                        ("<html>  Help: Enter a name or an IP address and port " +
                                "of server which you want to remote.<br>  Example: 192.168.0.1:9999</html>");
        ...
        this.connect_label.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
...
//        this.host_label.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        this.low_radio.setFont(new Font("Trebuchet MS", Font.BOLD, 13));
        ...
        this.high_radio.setFont(new Font("Trebuchet MS", Font.BOLD, 13));
